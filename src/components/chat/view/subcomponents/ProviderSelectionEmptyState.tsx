...
const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    id: "copilot",
    name: "Copilot",
    infoKey: "providerSelection.providerInfo.copilot",
    ...
    return (
      <div className="flex h-full items-center justify-center px-4">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 grid grid-cols-3 gap-2 sm:grid-cols-5 sm:gap-2.5">
            {PROVIDERS.map((p) => {
              ...
              {
                {
                  ...
                  copilot: t("providerSelection.readyPrompt.copilot", {
                    model: copilotModel,
                    defaultValue: `Ready to chat with GitHub Copilot (${copilotModel})`,
                  }),
                }[provider]
              }
            </p>
